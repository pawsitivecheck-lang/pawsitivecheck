        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white rounded-xl p-6 shadow-md">
                  ...
                  <h3 className="font-bold text-gray-900 mb-3">Barcode Recognition</h3>
                ...
                <div className="bg-white rounded-xl p-6 shadow-md">
                  ...
                  <h3 className="font-bold text-gray-900 mb-3">Image Recognition</h3>
                  <p className="text-gray-600 text-sm">
                ...
                <div className="bg-white rounded-xl p-6 shadow-md">
                  ...
                  <h3 className="font-bold text-gray-900 mb-3">Internet Discovery</h3>
                  <p className="text-gray-600 text-sm">
          ...
          <section className="mb-16">
            ...
            <div className="space-y-8">
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-3">1. Ingredient Database Cross-Reference</h3>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-3">2. Transparency Score Calculation</h3>
                  <p className="text-gray-700 mb-4">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-3">3. Cosmic Safety Rating</h3>
                  <p className="text-gray-700 mb-4">
          ...
          <section className="mb-16">
            <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-4">The Scale of the Problem</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Instant Protection</h3>
                  <div className="space-y-4">
                    <div className="bg-white rounded-lg p-4 shadow-sm">
          ...
          <section className="mb-16">
            <div className="bg-blue-50 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-gray-700 font-medium mb-2">Barcode Recognition</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-700 font-medium mb-2">Image Recognition</div>
                  <p className="text-sm text-gray-600">
            ...
            <div className="mt-8 bg-gray-50 rounded-xl p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Data Sources & Validation</h3>
              <p className="text-gray-700 mb-4">
