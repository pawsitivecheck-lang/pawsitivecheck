      ...
      <div className="pt-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-16">
            <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-950/20 dark:to-blue-950/20 rounded-2xl p-8 mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-card rounded-xl p-6 shadow-md">
                  ...
                  <h3 className="font-bold text-foreground mb-3">2.1M+ Products</h3>
                ...
                <div className="bg-card rounded-xl p-6 shadow-md">
                  ...
                  <h3 className="font-bold text-foreground mb-3">45K+ Safety Records</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div className="bg-card rounded-xl p-6 shadow-md">
                  ...
                  <h3 className="font-bold text-foreground mb-3">15K+ Ingredients</h3>
                  <p className="text-muted-foreground text-sm">
          ...
          <section className="mb-16">
            ...
            <div className="space-y-8">
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-foreground mb-3">Federal Regulatory Databases</h3>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-foreground mb-3">Scientific Research Integration</h3>
                  <p className="text-muted-foreground mb-4">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-foreground mb-3">Corporate Accountability Records</h3>
                  <p className="text-muted-foreground mb-4">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-foreground mb-3">Industry Transparency Monitoring</h3>
                  <p className="text-muted-foreground mb-4">
          ...
          <section className="mb-16">
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-bold text-foreground mb-4">Automated Data Ingestion</h3>
                  <div className="space-y-4">
                    <div className="bg-card rounded-lg p-4 shadow-sm">
                      <div className="flex items-start gap-3">
                        <CheckCircle className="text-green-600 h-5 w-5 mt-1 flex-shrink-0" />
                        <div>
                          <p className="font-medium text-foreground">FDA Recall Monitoring</p>
                    ...
                    <div className="bg-card rounded-lg p-4 shadow-sm">
                      <div className="flex items-start gap-3">
                        <CheckCircle className="text-green-600 h-5 w-5 mt-1 flex-shrink-0" />
                        <div>
                          <p className="font-medium text-foreground">Research Integration</p>
                          <p className="text-sm text-muted-foreground">
                    ...
                    <div className="bg-card rounded-lg p-4 shadow-sm">
                      <div className="flex items-start gap-3">
                        <CheckCircle className="text-green-600 h-5 w-5 mt-1 flex-shrink-0" />
                        <div>
                          <p className="font-medium text-foreground">Legal Case Tracking</p>
                          <p className="text-sm text-muted-foreground">
                ...
                <div>
                  <h3 className="text-xl font-bold text-foreground mb-4">Data Validation & Accuracy</h3>
                  <div className="space-y-4">
                    <div className="bg-card rounded-lg p-4 shadow-sm">
                      <div className="flex items-start gap-3">
                        <Shield className="text-blue-600 h-5 w-5 mt-1 flex-shrink-0" />
                        <div>
                          <p className="font-medium text-foreground">Multi-Source Verification</p>
                          <p className="text-sm text-muted-foreground">
                    ...
                    <div className="bg-card rounded-lg p-4 shadow-sm">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-medium text-foreground">Automated Quality Checks</p>
                          <p className="text-sm text-muted-foreground">
                    ...
                    <div className="bg-card rounded-lg p-4 shadow-sm">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-medium text-foreground">Performance Monitoring</p>
                          <p className="text-sm text-muted-foreground">
          ...
          <section className="mb-16">
            <div className="bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-950/20 dark:to-orange-950/20 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-bold text-foreground mb-4">The Hidden Crisis</h3>
                  <div className="space-y-4">
                    <div className="bg-card rounded-lg p-4 shadow-sm">
                  ...
                  <div className="space-y-4">
                    <div className="bg-card rounded-lg p-4 shadow-sm">
                      <div className="flex items-start gap-3">
                        <CheckCircle className="text-green-600 h-5 w-5 mt-1 flex-shrink-0" />
                        <div>
                          <p className="font-medium text-foreground">Instant Access to Safety Data</p>
                          <p className="text-sm text-muted-foreground">
                    ...
                    <div className="bg-card rounded-lg p-4 shadow-sm">
                      <div className="flex items-start gap-3">
                        <CheckCircle className="text-green-600 h-5 w-5 mt-1 flex-shrink-0" />
                        <div>
                          <p className="font-medium text-foreground">Corporate Accountability Tracking</p>
                          <p className="text-sm text-muted-foreground">
                    ...
                    <div className="bg-card rounded-lg p-4 shadow-sm">
                      <div className="flex items-start gap-3">
                        <CheckCircle className="text-green-600 h-5 w-5 mt-1 flex-shrink-0" />
                        <div>
                          <p className="font-medium text-foreground">Evidence-Based Analysis</p>
                          <p className="text-sm text-muted-foreground">
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-4 gap-6 text-center">
                <div>
                  ...
                  <div className="text-foreground font-medium mb-2">Uptime</div>
                  <p className="text-sm text-muted-foreground">
                ...
                <div>
                  ...
                  <div className="text-foreground font-medium mb-2">Query Response</div>
                  <p className="text-sm text-muted-foreground">
                ...
                <div>
                  ...
                  <div className="text-foreground font-medium mb-2">Update Frequency</div>
                  <p className="text-sm text-muted-foreground">
                ...
                <div>
                  ...
                  <div className="text-foreground font-medium mb-2">Monitoring</div>
                  <p className="text-sm text-muted-foreground">
