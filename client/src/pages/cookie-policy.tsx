        ...
        <CardContent className="space-y-8">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-white/50 dark:bg-gray-800/50 rounded-lg p-3 space-y-2">
                        <h4 className="font-medium text-sm text-gray-900 dark:text-gray-100">Examples:</h4>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-white/50 dark:bg-gray-800/50 rounded-lg p-3 space-y-2">
                        <h4 className="font-medium text-sm text-gray-900 dark:text-gray-100">What we track:</h4>
                        <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-white/50 dark:bg-gray-800/50 rounded-lg p-3 space-y-2">
                        <h4 className="font-medium text-sm text-gray-900 dark:text-gray-100">Purpose:</h4>
                        <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-white/50 dark:bg-gray-800/50 rounded-lg p-3 space-y-2">
                        <h4 className="font-medium text-sm text-gray-900 dark:text-gray-100">Features enabled:</h4>
                        <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
          ...
          <section className="space-y-4">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-4">
              ...
              <ul className="mt-3 space-y-2 text-gray-600 dark:text-gray-400 ml-4">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <Card className="border-gray-200 dark:border-gray-700">
                  <CardContent className="pt-4">
                    <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Server Storage</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <Card className="border-purple-200 dark:border-purple-700">
                  <CardContent className="pt-4">
                    <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Update Preferences Anytime</h3>
                ...
                <Card className="border-gray-200 dark:border-gray-700">
                  <CardContent className="pt-4">
                    <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Browser Controls</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      You can also control cookies through your browser settings. Most browsers allow you to:
                    </p>
                    <ul className="mt-2 text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
