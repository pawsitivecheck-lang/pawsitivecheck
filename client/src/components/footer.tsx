      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8">
          ...
          <div className="text-center sm:text-left sm:col-span-2 lg:col-span-1">
            <h4 className="text-lg font-bold text-foreground mb-3" data-testid="text-contact-title">Contact & Support</h4>
            <ul className="space-y-3 text-muted-foreground text-sm">
              <li>
                <div className="space-y-1">
                  <a href="mailto:pawsitivecheck@gmail.com" className="hover:text-foreground transition-colors cursor-pointer block font-medium" data-testid="link-contact-email">
              ...
              <li>
                <div className="space-y-1">
                  <a href="tel:+1-888-426-4435" className="hover:text-foreground transition-colors cursor-pointer block font-medium" data-testid="link-contact-poison-control">
                    📞 1-888-426-4435
                  </a>
                  <div className="text-xs text-muted-foreground/70 ml-4">
        ...
        <div className="border-t border-border pt-6">
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground/70 text-xs mt-2" data-testid="text-footer-motto">
